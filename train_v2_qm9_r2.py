...
files_to_log = [
    '/home/data1/lk/project/mol_tree/train_v2_qm9_r2.py',
    '/home/data1/lk/project/mol_tree/tools.py',
    # '/home/data1/lk/project/mol_tree/model.py',
    '/home/data1/lk/project/mol_tree/model_test.py',
    # '/home/data1/lk/project/mol_tree/dataset_v2.py'
    "/home/data1/lk/project/mol_tree/dataset_v2_bigvalue.py"
]
...
test_dataloader = DataLoader(test_dataset, batch_size=4096, shuffle=False, num_workers=2)

# 创建数据加载器
train_dataloader = DataLoader(train_dataset, batch_size=4096, shuffle=True, num_workers=2)
val_dataloader = DataLoader(val_dataset, batch_size=4096, shuffle=False, num_workers=2)
...
def infer(model, dataloader, mode=None):
    ...
    # else:
    # import pdb;pdb.set_trace()
    # metrics3 = calculate_metrics(dataset.denormalize(target2), dataset.denormalize( ( output1 + 1 ) * target3 ))
