...
# 示例：从文件中读取数据
file_path = '/home/data1/lk/project/mol_property/data/esol/esol.csv'
...
save_path = f'/home/data1/lk/project/mol_tree/graph/esol/evolution_graph_{len(data_)}_{tree_construct_kenerl_method}_{threshold}_v2.json'  # Specify the path where you want to save the graph
save_graph(molecule_graph, atom_groups, save_path)

# 可视化图
visualize_graph(molecule_graph, atom_groups, f'/home/data1/lk/project/mol_tree/graph/esol/evolution_graph_{len(data_)}_{tree_construct_kenerl_method}_{threshold}_v2.png')
