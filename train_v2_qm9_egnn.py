...
log_file = os.path.join(log_dir, f'Egnn_qm9_{label_name}_training_log_{start_time}.log')
...
files_to_log = [
    '/home/data1/lk/project/mol_tree/train_v2_qm9_egnn.py',
    '/home/data1/lk/project/mol_tree/tools.py',
    '/home/data1/lk/project/mol_tree/model_egnn.py',
    # '/home/data1/lk/project/mol_tree/dataset_v2.py'
    "/home/data1/lk/project/mol_tree/dataset_v2_test_egnn.py"
]
