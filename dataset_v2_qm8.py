...
class MoleculeACDataset_v2(Dataset):
    def __init__(self, graph_file, labels_file, test_file=None, mode='train', label_name = 'f1-CC2'):
        ...
        self.labels_dict = self.labels_df.set_index('smiles')[self.label_name].to_dict()
    ...
    def construct_dataset(self):
        ...
        for edge in self.graph_data['edges']:
            ...
            # import pdb;pdb.set_trace()
            label1 = self.labels_dict.get(mol1, {'E1-CC2': None})
            label2 = self.labels_dict.get(mol2, {'E1-CC2': None})
            dataset.append({
                'molecule_1': mol1,
                'molecule_2': mol2,
                'label1': label1,
    ...
    def __getitem__(self, idx):
        ...
        # import pdb;pdb.set_trace()
        # 这里可以加入标签或其他特征
        label_list = [x for x in data[['label1', 'label2']].values]
