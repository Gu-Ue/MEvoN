...
log_file = os.path.join(log_dir, f'gin_qm9_{label_name}_training_log_{start_time}.log')
...
files_to_log = [
    '/home/data1/lk/project/mol_tree/train_v2_qm9_GIN.py',
...
def save_checkpoint(model, optimizer, scheduler, epoch, loss, pth_dir, start_time):
    ...
    # print(f"Checkpoint saved at: {pth_file}")
