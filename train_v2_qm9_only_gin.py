...
from model_gin import GNNModel
...
log_file = os.path.join(log_dir, f'only_gin_qm9_{label_name}_training_log_{start_time}.log')
...
files_to_log = [
    '/home/data1/lk/project/mol_tree/train_v2_qm9_only_gin.py',
    '/home/data1/lk/project/mol_tree/tools.py',
    # '/home/data1/lk/project/mol_tree/model.py',
    '/home/data1/lk/project/mol_tree/model_gin.py',
...
# 保存所有状态
def save_checkpoint(model, optimizer, scheduler, epoch, loss, pth_dir, start_time):
    checkpoint = {
    ...
    # pth_file = os.path.join(pth_dir, f'checkpoint_epoch_{start_time}.pth')
    torch.save(checkpoint, pth_dir)
    # print(f"Checkpoint saved at: {pth_dir}")
...
#     optimizer=optimizer,
#     scheduler=scheduler,
#     pth_file='/home/data1/lk/project/mol_tree/checkpoint/gnn_model_epoch_20250111_033727.pth'
# )
