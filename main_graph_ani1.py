...
# 示例：从文件中读取数据
file_path = '/home/data1/lk/project/mol_property/data/ANI-1_release/ani1.csv'
...
save_path = f'/home/data1/lk/project/mol_tree/graph/ani1/evolution_graph_{len(data_)}_{tree_construct_kenerl_method}_{threshold}_v2.json'  # Specify the path where you want to save the graph
