...
from dataset_v2_ani1 import MoleculeACDataset_v2
...
log_file = os.path.join(log_dir, f'ani1_{label_name}_training_log_{start_time}.log')
...
files_to_log = [
    '/home/data1/lk/project/mol_tree/train_v2_ani1.py',
    '/home/data1/lk/project/mol_tree/tools.py',
    '/home/data1/lk/project/mol_tree/model.py',
    '/home/data1/lk/project/mol_tree/dataset_v2_ani1.py'
]
...
# File paths
input_file = "/home/data1/lk/project/mol_tree/graph/ani1/evolution_graph_57462_['edit_distance', 'graph']_0.3_v2.json"
output_file = "/home/data1/lk/project/mol_tree/graph/ani1/test_smiles.txt"
dataset_file = '/home/data1/lk/project/mol_tree/graph/ani1/ani1.csv'
...
smiles_list =  list(set([item for sublist in  data.get('edges', []) for item in sublist]))
...
print("Label logarithmic transformation is:", label_logarithmic_transformation)
...
test_dataloader = DataLoader(test_dataset, batch_size=2048, shuffle=False, num_workers=3)

# 创建数据加载器
train_dataloader = DataLoader(train_dataset, batch_size=2048, shuffle=True, num_workers=5)
